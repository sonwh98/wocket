...
return (new CustomEvent(event_name,(function (){var obj38981 = ({"detail":data});
return obj38981;
})()));
} else {
...
var f = (function (){var pred__38988 = cljs.core._EQ_;
var expr__38989 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38988.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38989))){
return ((function (pred__38988,expr__38989){
return (function (p1__38982_SHARP_){
return console.warn(p1__38982_SHARP_);
});
;})(pred__38988,expr__38989))
} else {
if(cljs.core.truth_(pred__38988.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38989))){
return ((function (pred__38988,expr__38989){
return (function (p1__38983_SHARP_){
return console.debug(p1__38983_SHARP_);
});
;})(pred__38988,expr__38989))
} else {
if(cljs.core.truth_(pred__38988.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38989))){
return ((function (pred__38988,expr__38989){
return (function (p1__38984_SHARP_){
return console.error(p1__38984_SHARP_);
});
;})(pred__38988,expr__38989))
} else {
return ((function (pred__38988,expr__38989){
return (function (p1__38985_SHARP_){
return console.log(p1__38985_SHARP_);
});
;})(pred__38988,expr__38989))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38992){
...
var eval_fn = cljs.core.get.call(null,map__38993__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__38995_SHARP_);
});})(new_def))
);
...
return (function (p__38996){
var vec__38997 = p__38996;
var ky = cljs.core.nth.call(null,vec__38997,(0),null);
var v = cljs.core.nth.call(null,vec__38997,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1554201134817
