...
var G__38691 = (function (){var G__38689 = sb;
G__38689.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__38689;
})();
var G__38692 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__38691;
ch = G__38692;
continue;
}
...
var temp__5718__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__38693 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__38693,ch);
...
var vec__38701 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38701,(0),null);
var start_column = cljs.core.nth.call(null,vec__38701,(1),null);
...
var G__38705 = (((!((mret === rdr))))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__38705;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__38704 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__38704,ch);

return G__38704;
})(),true,null,opts);
var G__38706 = (((!((o === rdr))))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__38706;
continue;
}
}
...
var vec__38707 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38707,(0),null);
var start_column = cljs.core.nth.call(null,vec__38707,(1),null);
...
var sb = (function (){var G__38710 = (new goog.string.StringBuffer());
G__38710.append(initch);
...
var G__38712 = (function (){var G__38711 = sb;
G__38711.append(ch);

return G__38711;
})();
var G__38713 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__38712;
ch = G__38713;
continue;
}
...
while(true){
var G__38716 = ch;
if(cljs.core._EQ_.call(null,null,G__38716)){
...
if(cljs.core._EQ_.call(null,"\\",G__38716)){
var G__38719 = (function (){var G__38717 = sb;
G__38717.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));
...
var G__38721 = (function (){var G__38718 = sb;
G__38718.append(ch);

return G__38718;
})();
var G__38722 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__38721;
ch = G__38722;
continue;
...
var G__38726 = rdr;
cljs.tools.reader.edn.read.call(null,G__38726,true,null,true);
...
var temp__5718__auto__ = (function (){var G__38727 = token;
var G__38727__$1 = (((G__38727 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__38727));
if((G__38727__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__38727__$1);
}
})();
if(cljs.core.truth_(temp__5718__auto__)){
...
var G__38728 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__38728)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__38728)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__38728)){
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__38735,reader){
...
var opts = map__38736__$1;
var eof = cljs.core.get.call(null,map__38736__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
}catch (e38738){if((e38738 instanceof Error)){
var e = e38738;
...
//# sourceMappingURL=edn.js.map?rel=1554201134225
