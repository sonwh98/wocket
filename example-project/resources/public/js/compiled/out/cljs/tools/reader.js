...
var G__38508 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__38508;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__38509 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__38509,ch);
...
if(("\\" === ch__$1)){
var ch_38510__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_38510__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_38510__$2);
} else {
}

var G__38511 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__38511;
continue;
}
}
...
var vec__38519 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38519,(0),null);
var start_column = cljs.core.nth.call(null,vec__38519,(1),null);
...
var G__38522 = cljs.core.conj_BANG_.call(null,a,form);
a = G__38522;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__38523 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__38524 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__38524;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__38523;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__38525 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38525,(0),null);
var start_column = cljs.core.nth.call(null,vec__38525,(1),null);
...
var vec__38528 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38528,(0),null);
var end_column = cljs.core.nth.call(null,vec__38528,(1),null);
...
var vec__38531 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38531,(0),null);
var start_column = cljs.core.nth.call(null,vec__38531,(1),null);
...
var vec__38534 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38534,(0),null);
var end_column = cljs.core.nth.call(null,vec__38534,(1),null);
...
var vec__38537 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38537,(0),null);
var start_column = cljs.core.nth.call(null,vec__38537,(1),null);
...
var vec__38540 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38540,(0),null);
var end_column = cljs.core.nth.call(null,vec__38540,(1),null);
...
var sb = (function (){var G__38543 = (new goog.string.StringBuffer());
G__38543.append(initch);
...
var G__38545 = (function (){var G__38544 = sb;
G__38544.append(ch);

return G__38544;
})();
var G__38546 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__38545;
ch = G__38546;
continue;
}
...
switch (G__38549) {
case "\\":
var G__38553 = (function (){var G__38550 = sb;
G__38550.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__38550;
})();
var G__38554 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__38553;
ch = G__38554;
continue;
...
break;
default:
var G__38555 = (function (){var G__38551 = sb;
G__38551.append(ch);

return G__38551;
})();
var G__38556 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__38555;
ch = G__38556;
continue;
...
var vec__38557 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38557,(0),null);
var end_column = cljs.core.nth.call(null,vec__38557,(1),null);
...
var vec__38560 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__38560,(0),null);
var column = cljs.core.nth.call(null,vec__38560,(1),null);
...
var vec__38565 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__38565,(0),null);
var column = cljs.core.nth.call(null,vec__38565,(1),null);
...
var vec__38570 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__38570,(0),null);
var column = cljs.core.nth.call(null,vec__38570,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__38575 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38575,(0),null);
var start_column = cljs.core.nth.call(null,vec__38575,(1),null);
...
var vec__38578 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38578,(0),null);
var end_column = cljs.core.nth.call(null,vec__38578,(1),null);
...
var G__38581 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__38581,true,null,opts,pending_forms);
...
var G__38582 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__38582)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__38582)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__38582)){
...
var _STAR_suppress_read_STAR__orig_val__38583 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__38584 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__38584;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__38583;
}});
...
var G__38585 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__38585,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__38585,rdr,first_line);
...
var G__38589 = matched;
var G__38590 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__38589;
finished = G__38590;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__38591 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__38592 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__38592;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__38591;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__38593 = cljs.tools.reader.arg_env;
var arg_env_temp_val__38594 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__38594;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__38595 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__38595,"(");
...
var G__38596 = (i + (1));
var G__38597 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__38593;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__38598 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__38598);
...
var G__38599 = cljs.core.next.call(null,s__$1);
var G__38600 = ret;
s__$1 = G__38599;
r = G__38600;
continue;
...
var G__38601 = cljs.core.next.call(null,s);
var G__38602 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__38601;
key_vals = G__38602;
continue;
} else {
...
var gensym_env_orig_val__38606 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__38607 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__38607;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__38606;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__38608 = token;
var G__38608__$1 = (((G__38608 == null))?null:cljs.core.subs.call(null,G__38608,(1)));
var G__38608__$2 = (((G__38608__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__38608__$1));
var G__38608__$3 = (((G__38608__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__38608__$2));
var G__38608__$4 = (((G__38608__$3 == null))?null:cljs.core.symbol.call(null,G__38608__$3));
if((G__38608__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__38608__$4);
}
})():(function (){var G__38609 = token;
var G__38609__$1 = (((G__38609 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__38609));
if((G__38609__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__38609__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__38620,reader){
...
var opts = map__38621__$1;
var eof = cljs.core.get.call(null,map__38621__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1554201133820
