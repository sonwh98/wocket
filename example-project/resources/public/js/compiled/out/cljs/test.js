...
var G__34550 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__34550,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__34550;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq34552){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34553,G__34554,seq34552__$2);
});
...
var line = cljs.core.get.call(null,map__34559__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34559__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__34559,map__34559__$1,file,line,column){
return (function (p1__34558_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__34558_SHARP_));
});})(map__34559,map__34559__$1,file,line,column))
...
var temp__5720__auto___34561 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___34561)){
var message_34562 = temp__5720__auto___34561;
cljs.core.println.call(null,message_34562);
} else {
}
...
var temp__5720__auto___34563 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___34563)){
var message_34564 = temp__5720__auto___34563;
cljs.core.println.call(null,message_34564);
} else {
}
...
var output_dir__$1 = (function (){var G__34565 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__34565,"/"].join('');
} else {
return G__34565;
}
})();
...
var G__34567 = exception.stack;
var G__34567__$1 = (((G__34567 == null))?null:clojure.string.split_lines.call(null,G__34567));
var G__34567__$2 = (((G__34567__$1 == null))?null:cljs.core.get.call(null,G__34567__$1,depth));
if((G__34567__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__34567__$2);
}
} else {
...
var vec__34568 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__34568,(0),null);
var column = cljs.core.nth.call(null,vec__34568,(1),null);
var vec__34571 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__34571,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__34571,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__34571,(2),null);
...
var m__$1 = (function (){var G__34574 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__34578 = (function (){var G__34577 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__34577);
} else {
return G__34577;
}
})();
...
return cljs.core.vary_meta.call(null,G__34579,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__34583 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__34583,(0),null);
var types = vec__34583;
...
return cljs.core.map.call(null,(function (p__34586){
var vec__34587 = p__34586;
var ns = cljs.core.nth.call(null,vec__34587,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__34587,(1),null);
return ((function (vec__34587,ns,vars__$1){
return (function (){
...
var G__34590 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1){
return (function (){
var seq__34591 = cljs.core.seq.call(null,vars__$1);
var chunk__34592 = null;
var count__34593 = (0);
var i__34594 = (0);
while(true){
if((i__34594 < count__34593)){
var v = cljs.core._nth.call(null,chunk__34592,i__34594);
var temp__5720__auto___34596 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___34596)){
var t_34597 = temp__5720__auto___34596;
each_fixture_fn.call(null,((function (seq__34591,chunk__34592,count__34593,i__34594,t_34597,temp__5720__auto___34596,v,each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_34597)));
});})(seq__34591,chunk__34592,count__34593,i__34594,t_34597,temp__5720__auto___34596,v,each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1))
);
} else {
}


var G__34598 = seq__34591;
var G__34599 = chunk__34592;
var G__34600 = count__34593;
var G__34601 = (i__34594 + (1));
seq__34591 = G__34598;
chunk__34592 = G__34599;
count__34593 = G__34600;
i__34594 = G__34601;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__34591);
if(temp__5720__auto__){
var seq__34591__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__34591__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__34591__$1);
var G__34602 = cljs.core.chunk_rest.call(null,seq__34591__$1);
var G__34603 = c__4550__auto__;
var G__34604 = cljs.core.count.call(null,c__4550__auto__);
var G__34605 = (0);
seq__34591 = G__34602;
chunk__34592 = G__34603;
count__34593 = G__34604;
i__34594 = G__34605;
continue;
} else {
var v = cljs.core.first.call(null,seq__34591__$1);
var temp__5720__auto___34606__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___34606__$1)){
var t_34607 = temp__5720__auto___34606__$1;
each_fixture_fn.call(null,((function (seq__34591,chunk__34592,count__34593,i__34594,t_34607,temp__5720__auto___34606__$1,v,seq__34591__$1,temp__5720__auto__,each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_34607)));
});})(seq__34591,chunk__34592,count__34593,i__34594,t_34607,temp__5720__auto___34606__$1,v,seq__34591__$1,temp__5720__auto__,each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1))
);
} else {
}


var G__34608 = cljs.core.next.call(null,seq__34591__$1);
var G__34609 = null;
var G__34610 = (0);
var G__34611 = (0);
seq__34591 = G__34608;
chunk__34592 = G__34609;
count__34593 = G__34610;
i__34594 = G__34611;
continue;
}
} else {
...
});})(each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1))
);
});})(each_fixture_fn,G__34590,G__34590__$1,env,once_fixtures,each_fixtures,vec__34587,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34590__$1)].join('')));

}
})());
});
;})(vec__34587,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1554200932809
