...
var o37177 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37177["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37178 = temp__5718__auto____$1;
return (o37178["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37029__auto__ = f;
return (o__37029__auto__["toString"]).call(o__37029__auto__);
} else {
return "";
}
}catch (e37179){var _ = e37179;
return "";
}});
...
try{var o__37029__auto___37181 = t;
(o__37029__auto___37181["cljs$lang$ctorPrWriter"]).call(o__37029__auto___37181,t,writer);
}catch (e37180){var __37182 = e37180;
}
...
var char_code = (function (){var o__37029__auto__ = (new String(char$));
return (o__37029__auto__["charCodeAt"]).call(o__37029__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37029__auto__ = String;
return (o__37029__auto__["fromCharCode"]).call(o__37029__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37183 = num_code;
switch (G__37183) {
case (1):
return (185);
...
var o__37029__auto__ = String;
return (o__37029__auto__["fromCharCode"]).call(o__37029__auto__,superscript_code);
});
/**
...
}catch (e37185){var _e__37036__auto__ = e37185;
return false;
}})())){
...
var vec__37186 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37186,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o37189 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37189["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37190 = temp__5718__auto____$1;
return (o37190["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37193){
var vec__37194 = p__37193;
var ns_detector = cljs.core.nth.call(null,vec__37194,(0),null);
...
var G__37200 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37201 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37200;
remaining_tokens = G__37201;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37191){
...
var vec__37205 = cljs.core.split_with.call(null,(function (p1__37204_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37204_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37205,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37205,(1),null);
...
var vec__37211 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37211,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37211,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37214 = cljs.core.rest.call(null,remaining_tokens);
var G__37215 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37214;
name_tokens = G__37215;
continue;
} else {
...
var vec__37218 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37218,(0),null);
var arity = cljs.core.nth.call(null,vec__37218,(1),null);
var vec__37221 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37221,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37221,(1),null);
var vec__37224 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37224,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37224,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37224,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37224,(3),null);
...
var vec__37230 = result;
var munged_ns = cljs.core.nth.call(null,vec__37230,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37230,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37230,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37230,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37230,(4),null);
var arity = cljs.core.nth.call(null,vec__37230,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__37234 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__37234,(0),null);
var args = cljs.core.nth.call(null,vec__37234,(1),null);
var vec__37237 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37237,(0),null);
var name = cljs.core.nth.call(null,vec__37237,(1),null);
...
var G__37240 = (arity + (1));
var G__37241 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37242){
var vec__37243 = p__37242;
var arity = cljs.core.nth.call(null,vec__37243,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37243,(1),null);
...
return cljs.core.get.call(null,arities,p1__37246_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37247_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___37254 = arguments.length;
var i__4731__auto___37255 = (0);
while(true){
if((i__4731__auto___37255 < len__4730__auto___37254)){
args__4736__auto__.push((arguments[i__4731__auto___37255]));

var G__37256 = (i__4731__auto___37255 + (1));
i__4731__auto___37255 = G__37256;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37250){
var vec__37251 = p__37250;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37251,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37248){
var G__37249 = cljs.core.first.call(null,seq37248);
var seq37248__$1 = cljs.core.next.call(null,seq37248);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37249,seq37248__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37259__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37259__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37259__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37259__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37260 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37260,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37260,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37260,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37260,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37260,(4),null);
var arity = cljs.core.nth.call(null,vec__37260,(5),null);
...
var o__37029__auto__ = f;
return (o__37029__auto__["getBasis"]).call(o__37029__auto__);
});
/**
...
}catch (e37264){var _e__37036__auto__ = e37264;
...
var G__37265 = (obj[cljs.core.first.call(null,path)]);
var G__37266 = cljs.core.rest.call(null,path);
obj = G__37265;
path = G__37266;
continue;
} else {
...
return (function (accum,p__37267){
var vec__37268 = p__37267;
var bit = cljs.core.nth.call(null,vec__37268,(0),null);
var protocol = cljs.core.nth.call(null,vec__37268,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37271){
var vec__37272 = p__37271;
var ns = cljs.core.nth.call(null,vec__37272,(0),null);
var name = cljs.core.nth.call(null,vec__37272,(1),null);
var selector = cljs.core.nth.call(null,vec__37272,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__37277,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37277,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37277,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37275_SHARP_){
return (obj[cljs.core.first.call(null,p1__37275_SHARP_)]);
});})(name,sorted_matches,vec__37277,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1554200937676
